...
//    public void TransferChargeTo(Pack otherPack, ChargeParticle charge)
//        {
//        if (otherPack == null || charge == null) return;
//        if (charges != null && charges.Contains(charge))
//        {
//            charges.Remove(charge);
//            otherPack.AddCharge(charge);
//            charge.SetParentPack(otherPack);
//        }
//    }
