...
//     [SerializeField] private float carrierMobility = 0.5f; // Higher = more responsive to forces
//     [SerializeField] private float velocityDamping = 0.8f; // Friction factor per frame

//     [Header("Hall Effect Parameters")]
//     [SerializeField] private float hallCoefficient = 0.001f; // Controls E_H strength
...
//     // Plate geometry
//     private Vector3 flowDirection = Vector3.right;        // X-axis: left to right
//     private Vector3 lateralDirection = Vector3.up;        // Y-axis: bottom to top
//     private Vector3 depthDirection = Vector3.forward;     // Z-axis: front to back
...
//             // Calculate charge sign (for this carrier type)
...
//             // 2. UPDATE VELOCITY
//             // Apply force with mobility scaling and damping
//             p.Velocity += totalForce * carrierMobility * dt;
//             p.Velocity *= velocityDamping; // Friction from lattice collisions

//             // 3. ENFORCE FORWARD MOTION
//             // Maintain average forward speed based on voltage
...
//             float speedCorrection = (targetSpeed - currentForwardSpeed) * 0.5f; // Gentle correction
//             p.Velocity += currentFlowDir * speedCorrection;

//             // 4. UPDATE POSITION
//             p.transform.position += p.Velocity * dt;

//             // 5. ENFORCE BOUNDARIES - Keep particle inside material
...
//             // Forward boundary: despawn when exiting the material
...
//             // Lateral boundary: clamp to wall and accumulate charge
...
//     {
//         // Hall E-field is proportional to accumulated charge
//         // E_H = R_H * B * J / thickness ≈ (charge accumulation) / (material properties)
//         // Simplified: E_H = hallCoefficient * netLateralCharge
...
//         // Plate face spans Y (height) and Z (depth)
...
//         // Shuffle for randomized emission
